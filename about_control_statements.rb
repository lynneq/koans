...
class AboutControlStatements < EdgeCase::Koan
  ...
  def test_while_statement
    ...
    result = 1
    while i <= 10
      result = result * i # 1= 1*1, 2=1*2, 6= 2*3, 24=6*4, 24*5 = 120, 120*6 =720, 720*7 = 5040, 5040*8= 40320, 40320*9= 362880, 3628800
      i += 1
    end
  ...
  def test_next_statement
    ...
    while i < 10
      i += 1
      next if (i % 2) == 0  #Jumps to next iteration of the most internal loop.
      result << i
    end
