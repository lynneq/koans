...
class AboutIteration < EdgeCase::Koan
  ...
  def test_find_locates_the_first_element_matching_a_criteria
    ...
    assert_equal "Clarence", array.find { |item| item.size > 4 } # *first*
  end
  ...
  def test_inject_will_blow_your_mind
    ...
    result2 = [2, 3, 4].inject(1) { |sum, item| sum * item }#1*2, 2*3, 6*4
    assert_equal 24, result2

    # Extra Credit:
    # Describe in your own words what inject does.
    # At the end of the iteration, the final value of the sum is the return value of this method.
    # If you didn't specify the value of sum, it use the first element in the collection.
  end
