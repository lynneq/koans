...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # Some classes define their own send method which has nothing to do with Oject#send, so if you work
    # with objects of any class, you need to use __send__ to be on the safe side.
    # send existed first    
